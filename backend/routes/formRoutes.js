...
const { saveSection, submitForm, getMyForm, uploadDoc, createEditRequest, getMyEditRequest } = require("../controllers/formController");
...
router2.post("/edit-request", protect2, createEditRequest);
router2.get("/edit-request", protect2, getMyEditRequest);
